# What The Hack - ElasticsearchMigrationToAzure - Coach Guide

## Introduction

Welcome to the coach's guide for the ElasticsearchMigrationToAzure What The Hack. Here you will find links to specific guidance for coaches for each of the challenges.
